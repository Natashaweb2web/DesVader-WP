<footer>
    <div class="footer-container p-50 column center gap">
      <div class="logo ">
        <img src="./assets/images/cropped-desvader-logo 2.png" alt="DesVader-Logo-2" />
      </div>
      <div class="footer flex">
        <nav class="nav-links">
          <ul class="flex  navlinks-list">
              ...
              <svg width="38" height="37" viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_104_2159)">
                  <path
                    ...
                    stroke="white" stroke-opacity="0.7" stroke-width="4" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M15.5312 23.1558L24.3958 18.1146L15.5312 13.0733V23.1558Z" stroke="white"
      ...
      <div class="footer-text">
        <p>Web design and Development by Web2Web</p>

        <p>Copyright &#169; <span id="year"></span> Desmond Kurz of Des Vader Consulting.</p>
      </div>
    </div>
  </footer>
  <?php wp_footer();?>
